            ...
            <div>
                <div style={{ display: "flex", justifyContent: "center", paddingTop: "20px" }}>
                    <a className="d-block text-center">
                        <div onClick={(event) => clearCart(event)} style={{ display: "flex", justifyContent: "center", paddingTop: "20px" }}>
                            <img src="src/pictures/cart.jpg" alt="Add to Cart" style={{ width: "50px", height: "50px" }} />
                        </div>
                        <h10>Cart: {cartLength}</h10>
                        <div>
                            {cart.map((product) => (
                                <div onClick={(event) => removeCart(event, product)} key={product.name} style={{ display: "flex", justifyContent: "center", alignItems: "center"}}>
                                    <p>{`${product.name} (${product.quantity})`}</p>
                                    <img src={remove} style={{ paddingLeft: "10px" , paddingTop: "3px"}} width="4%" height="4%" />
                                </div>
                            ))}
                        </div>
                    </a>
